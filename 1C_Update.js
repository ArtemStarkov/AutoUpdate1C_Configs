...
var advFileName = 'C:\\Users\\Артем\\AppData\\Local\\1C\\1Cv8Update\\adv\\index.htm'; // Путь к файлу рекламы.
var cfgFileNames = ['C:\\Users\\Артем\\Desktop\\Арбис\\1c\\Accounting\\2.0.47.7\\1cv8.cfu']; // Пути к .cf/.cfu-файлам с обновлениями
var v8exe = 'C:\\Program Files (x86)\\1cv82\\8.2.17.169\\bin\\1cv8.exe' // Путь к исполняемому файлу 1С:Предприятия 8
var infoBasePath = '/F"C:\\Users\\Артем\\Documents\\Buh1"'; 
var connectionString = 'File="C:\\Users\\Артем\\Documents\\Buh1";' + 'UC=ПакетноеОбновлениеКонфигурацииИБ'; 
var infoBaseAuthorization = ''; 
var backupFileName = '' + 'backup' + now.valueOf() + '.dt';  // Файл резервной копии
var createBackup = true; // создавать резервную копию
var eventLogID = 'Обновление информационной базы';
var emailAddress = '';  // адрес электронной почты для отправки уведомления
var IBAdminName = ''; // имя администратора, от имени которого выполняется обновления
var IBAdminPassword = ''; // пароль администратора, от имени которого выполняется обновления
var adminName = '';	// имя администратора, инициировавшего обновление
var doBlockUsers = false;  // устанавливать блокировку соединений перед обновлением
var comConnectorName = 'v82.COMConnector';  // имя COM-класса для работы с 1С:Предприятием 8 через COM-соединение
var useComConnector = true;  // флаг использования COM-соединения для работы с 1С:Предприятием 8
